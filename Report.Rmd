...
# Create a plot that shows the number of unique SNP locations as a percentage
# of gene length
...
unique_snps_per <- cbind(unique_snps, 'percentage' = gene_per$percentage_of_gen)


# Create plot
ggplot2(unique_snps_per, aes(x = gene,
                        y = percentage_of_gen)) +
      geom_col() +
      labs(title = "Count of distinct SNPs in Named SARS-CoV-2 Genes",
          x = "Gene Name") +
