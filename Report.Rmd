...
![An example of one sample's per base sequence quality FastQC report](data/images/SRR12768739_1_per_base_seq_qual.png)
*An example of one sample's FastQC quality report showing per base sequence quality.*
  
&nbsp;

![An example of one sample's FastQC per sequence quality scores report](data/images/SRR12768739_1_per_seq_qual.png)
...
![An example of one sample's FastQC sequence length distribution](data/images/SRR12768739_1_seq_length_distr.png)
...
for (n in 1:seq_len(nrow(key_mutations))) {
  for (row in 1:seq_len(nrow(gene_table))) {
