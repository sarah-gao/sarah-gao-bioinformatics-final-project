...
```
**Figure 4**: Number of samples from this specific Beijing data set with common mutations found in samples globally.
...
chn_ourworld_tab %>%
  ...
  geom_line(aes(x = date,
                y = new_cases, color = "red")) +
  geom_line(aes(x = date,
                y = new_cases_smoothed, color = "blue")) +
  scale_color_discrete(name = "Y series", 
                       labels = str_wrap(c("Daily New Cases", 
                                  "Daily New Cases Smoothed Over 7 Days"), 
                                  width = 20))
```
